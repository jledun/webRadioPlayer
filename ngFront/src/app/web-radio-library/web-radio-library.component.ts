...
@Component({
  selector: 'app-web-radio-library',
  templateUrl: './web-radio-library.component.html',
  styleUrls: ['./web-radio-library.component.css']
})
export class WebRadioLibraryComponent {
  absVolume: number = 0;
  setVolume(event) {
